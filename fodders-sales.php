...
session_start();
    ...
    $fodder_purchases_query = "select * from fodder_purchases join fodders where fodders.id = fodder_purchases.fodder_id";
    $fodder_purchases = mysqli_query($con, $fodder_purchases_query);
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="fodders-sales.php">Fodders Sales</a></li>
    ...
    <section class="inner-page">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <?php
                    while($row = mysqli_fetch_array($fodder_purchases)) {
                ?>
