...
session_start();
    ...
    $my_reservs_query = "select * from products_reserv where customer_name = '$user_name' and response != ''";
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="all-farms-cli.php">All Farms</a></li>
          <li class="active"><a href="my-reservs.php">My Reservations</a></li>
